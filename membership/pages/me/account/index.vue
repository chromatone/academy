...
.flex.flex-col.gap-4.mx-4.max-w-55ch 
  ...
  .glass.p-4.flex.flex-col.gap-4.justify-center 
    ...
    .absolute.right-4.flex.gap-2
      NuxtLink.flex.gap-2.items-center.block.rounded-xl.flex-1.p-2.border-1.shadow-lg(to="/me/")
        .i-la-arrow-left
        .p-0 Profile
  ...
  button.text-xl.border-red.flex.gap-2.items-center.rounded-xl.flex-1.p-2.border-1.shadow-lg(@click="logout()")
    .i-la-door-open
    .p-0 Logout
