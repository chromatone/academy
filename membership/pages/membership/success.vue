...
.flex.flex-col.gap-6.p-6.glass.max-w-55ch.m-4
  ...
  NuxtLink.text-2xl.op-95.hover-op-100.transition.p-2.bg-purple-300.dark-bg-purple-700.rounded-xl.shadow.text-lg.flex-1(:to="academy?.discord_invite") Proceed to Chromatone Discord server
